   ...
   google::protobuf::FieldDescriptor::Type type )
{
   ...
   switch ( type )
   {
      ...
      case google::protobuf::FieldDescriptor::TYPE_SINT64:
         ...
         break;
      default:
         KOINOS_ASSERT_REVERSION( false, "attempted to retrieve the value of an unexpected field type" );
         break;
   }
...
value_type get_nested_field_value( execution_context& context, const google::protobuf::Message& parent_message, std::string field_name )
{
   ...
   KOINOS_ASSERT_REVERSION( pool_descriptor, "${type} descriptor was not found", ("type", parent_message.GetTypeName()) );
   ...
   for ( const auto& segment : field_path )
   {
      ...
      KOINOS_ASSERT_REVERSION( pool_field_descriptor, "unable to find field ${fname}", ("fname", segment) );
      ...
      KOINOS_ASSERT_REVERSION( field_descriptor, "unable to find field number ${fnum} on ${type} message", ("fnum", field_num)("type", message->GetTypeName()) );

      if ( &segment != &field_path.back() )
      {
         KOINOS_ASSERT_REVERSION( type == google::protobuf::FieldDescriptor::Type::TYPE_MESSAGE, "expected nested field to be within a message" );
