...
const statedb::object_space CONTRACT_SPACE_ID = uint256_t( "0x3e5bb9473a9187e1be1c8321fd2a44b9b85510a0000000000000000000000001" );
// First 160 bits are obtained by 160-bit truncation of sha256("object_space::system_call")
const statedb::object_space SYS_CALL_DISPATCH_TABLE_SPACE_ID = uint256_t( "0xd15cd01c47057163768c9d339a81495e6d167f20000000000000000000000001" );
...
std::optional< koinos::thunk::thunk_id > get_default_system_call_entry( system::system_call_id sid );
