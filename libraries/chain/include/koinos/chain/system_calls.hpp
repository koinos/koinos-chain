...
THUNK_DECLARE( put_object_result, put_object, const std::string& space, const std::string& key, const std::string& obj );
THUNK_DECLARE( get_object_result, get_object, const std::string& space, const std::string& key, uint32_t object_size_hint = 0 );
THUNK_DECLARE( get_next_object_result, get_next_object, const std::string& space, const std::string& key, uint32_t object_size_hint = 0 );
THUNK_DECLARE( get_prev_object_result, get_prev_object, const std::string& space, const std::string& key, uint32_t object_size_hint = 0 );
