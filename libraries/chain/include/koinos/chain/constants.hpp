...
const state_db::object_space contract_space = state_db::object_space( "0x3e5bb9473a9187e1be1c8321fd2a44b9b85510a0000000000000000000000001" );

// First 160 bits are obtained by 160-bit truncation of sha256("object_space::system_call")
const state_db::object_space system_call_dispatch_space = state_db::object_space( "0xd15cd01c47057163768c9d339a81495e6d167f20000000000000000000000001" );

// First 160 bits are obtained by 160-bit truncation of sha256("object_space::kernel")
const state_db::object_space kernel_space = state_db::object_space( "0xc72196cc927d29fc4c456f8672fc5d5141399be0000000000000000000000001" );
...
inline state_db::object_key key_from_string( const std::string& s )
{
   auto vkey = pack::to_variable_blob( s );
   vkey.resize( 32, char(0) );
   return pack::from_variable_blob< state_db::object_key >( vkey );
}
