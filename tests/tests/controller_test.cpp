...
{ try {
   ...
   auto future = _chain_plugin.submit( koinos::types::rpc::query_submission( koinos::types::rpc::get_head_info_params() ) );
   ...
   future = _chain_plugin.submit( koinos::types::rpc::query_submission( koinos::types::rpc::get_head_info_params() ) );
   ...
   auto& head_info_res = std::get< koinos::types::rpc::get_head_info_result >( query_res.get_native() );
...
{ try {
   ...
   BOOST_CHECK_THROW( _chain_plugin.submit( koinos::types::rpc::reserved_submission() ), unknown_submission_type );


   BOOST_TEST_MESSAGE( "Test reserved query" );

   auto future = _chain_plugin.submit( koinos::types::rpc::query_submission( koinos::types::rpc::reserved_query_params() ) );
   auto submit_res = *(future.get());
   auto& query_err = std::get< koinos::types::rpc::query_error >( std::get< koinos::types::rpc::query_submission_result >( submit_res ).get_const_native() );
   ...
   koinos::protocol::operation o = koinos::protocol::nop_operation();
   koinos::protocol::transaction transaction;
   transaction.operations.push_back( o );

   koinos::types::rpc::transaction_submission trx;
   trx.active_data = transaction.active_data;
   trx.passive_data = transaction.passive_data;
//   koinos::pack::to_variable_blob( trx.active_data, transaction );
   ...
   block_submission.topology.id = koinos::crypto::hash( CRYPTO_SHA2_256_ID, block_submission.block.active_data );
   ...
   future = _chain_plugin.submit( koinos::types::rpc::query_submission( koinos::types::rpc::get_chain_id_params() ) );
   submit_res = *(future.get());
   auto query_submission_result = std::get< koinos::types::rpc::query_submission_result >( submit_res );
   auto chain_id_result = std::get< koinos::types::rpc::get_chain_id_result >( query_submission_result.get_const_native() );
