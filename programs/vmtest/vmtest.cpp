...
int main(int argc, char** argv, char** envp)
{
   ...
   rhf_t::add< system_api, &system_api::__lshrti3, wasm_allocator >( "env", "__lshrti3" );
   rhf_t::add< system_api, &system_api::__divti3, wasm_allocator >( "env", "__divti3" );
   rhf_t::add< system_api, &system_api::__udivti3, wasm_allocator >( "env", "__udivti3" );
   rhf_t::add< system_api, &system_api::__multi3, wasm_allocator >( "env", "__multi3" );
   rhf_t::add< system_api, &system_api::__modti3, wasm_allocator >( "env", "__modti3" );
   rhf_t::add< system_api, &system_api::__umodti3, wasm_allocator >( "env", "__umodti3" );
   rhf_t::add< system_api, &system_api::__addtf3, wasm_allocator >( "env", "__addtf3" );
   rhf_t::add< system_api, &system_api::__subtf3, wasm_allocator >( "env", "__subtf3" );
   rhf_t::add< system_api, &system_api::__multf3, wasm_allocator >( "env", "__multf3" );
   rhf_t::add< system_api, &system_api::__divtf3, wasm_allocator >( "env", "__divtf3" );
   rhf_t::add< system_api, &system_api::__negtf2, wasm_allocator >( "env", "__negtf2" );
   rhf_t::add< system_api, &system_api::__extendsftf2, wasm_allocator >( "env", "__extendsftf2" );
   rhf_t::add< system_api, &system_api::__extenddftf2, wasm_allocator >( "env", "__extenddftf2" );
   rhf_t::add< system_api, &system_api::__trunctfdf2, wasm_allocator >( "env", "__trunctfdf2" );
   rhf_t::add< system_api, &system_api::__trunctfsf2, wasm_allocator >( "env", "__trunctfsf2" );
   rhf_t::add< system_api, &system_api::__fixtfsi, wasm_allocator >( "env", "__fixtfsi" );
   rhf_t::add< system_api, &system_api::__fixtfdi, wasm_allocator >( "env", "__fixtfdi" );
   rhf_t::add< system_api, &system_api::__fixtfti, wasm_allocator >( "env", "__fixtfti" );
   rhf_t::add< system_api, &system_api::__fixunstfsi, wasm_allocator >( "env", "__fixunstfsi" );
   rhf_t::add< system_api, &system_api::__fixunstfdi, wasm_allocator >( "env", "__fixunstfdi" );
   rhf_t::add< system_api, &system_api::__fixunstfti, wasm_allocator >( "env", "__fixunstfti" );
   rhf_t::add< system_api, &system_api::__fixsfti, wasm_allocator >( "env", "__fixsfti" );
   rhf_t::add< system_api, &system_api::__fixdfti, wasm_allocator >( "env", "__fixdfti" );
   rhf_t::add< system_api, &system_api::__fixunssfti, wasm_allocator >( "env", "__fixunssfti" );
   rhf_t::add< system_api, &system_api::__fixunsdfti, wasm_allocator >( "env", "__fixunsdfti" );
   rhf_t::add< system_api, &system_api::__floatsidf, wasm_allocator >( "env", "__floatsidf" );
   rhf_t::add< system_api, &system_api::__floatsitf, wasm_allocator >( "env", "__floatsitf" );
   rhf_t::add< system_api, &system_api::__floatditf, wasm_allocator >( "env", "__floatditf" );
   rhf_t::add< system_api, &system_api::__floatunsitf, wasm_allocator >( "env", "__floatunsitf" );
   rhf_t::add< system_api, &system_api::__floatunditf, wasm_allocator >( "env", "__floatunditf" );
   rhf_t::add< system_api, &system_api::__floattidf, wasm_allocator >( "env", "__floattidf" );
   rhf_t::add< system_api, &system_api::__floatuntidf, wasm_allocator >( "env", "__floatuntidf" );
   rhf_t::add< system_api, &system_api::___cmptf2, wasm_allocator >( "env", "___cmptf2" );
   rhf_t::add< system_api, &system_api::__eqtf2, wasm_allocator >( "env", "__eqtf2" );
   rhf_t::add< system_api, &system_api::__netf2, wasm_allocator >( "env", "__netf2" );
   rhf_t::add< system_api, &system_api::__getf2, wasm_allocator >( "env", "__getf2" );
   rhf_t::add< system_api, &system_api::__gttf2, wasm_allocator >( "env", "__gttf2" );
   rhf_t::add< system_api, &system_api::__letf2, wasm_allocator >( "env", "__letf2" );
   rhf_t::add< system_api, &system_api::__lttf2, wasm_allocator >( "env", "__lttf2" );
   rhf_t::add< system_api, &system_api::__cmptf2, wasm_allocator >( "env", "__cmptf2" );
   rhf_t::add< system_api, &system_api::__unordtf2, wasm_allocator >( "env", "__unordtf2" );
